...
public class StudentEventReducer extends
        Reducer<LongWritable, StudentEventWritable, LongWritable, Text> {
     ...
     */
    @Override
    public void reduce(LongWritable key, Iterable<StudentEventWritable> values, Context context)
        ...
        Collections.sort(studentEvents, new StudentEventWritable.StudentEventIdComparator());
